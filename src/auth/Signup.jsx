...
export default function SignupPage() {
    ...
    const submitfunction = async (e) => {
        ...
        try {
            ...
            let PhotoURL = ""
            if (pfp) {
                PhotoURL = await uploadImageToCloudinary(pfp)
                if (!pfp) {
                    toastify("Image is required", "error")
                    return;
                }
            }
    ...
    return (
        <div className="signup-page">
            <form className="signup-card" onSubmit={submitfunction}>
                ...
                <Link to={'/Login'} className="btn-signup" >Already have a account <span style={{ color: "black" }}>Login</span></Link>
            </form>
